        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div id="signinForm" class="bg-white rounded-lg shadow-lg p-8">
                ...
                <p class="mt-4 text-center text-sm text-gray-600">
                    ...
                    <button onclick="toggleForm()" class="text-yellow-600 hover:text-yellow-500">Sign up</button>
                </p>
            </div>
            ...
            <div id="signupForm" class="bg-white rounded-lg shadow-lg p-8 hidden">
                <form method="POST">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Password</label>
                            <input type="password" name="password" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md">
                ...
                <p class="mt-4 text-center text-sm text-gray-600">
                    ...
                    <button onclick="toggleForm()" class="text-yellow-600 hover:text-yellow-500">Sign in</button>
                </p>
            </div>

            <div class="text-center">
                <a href="../index.php" class="text-yellow-600 hover:text-yellow-500">← Back to Home</a>
            </div>
        </div>
    </div>
