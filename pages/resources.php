...
<section class="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=2072&q=80" alt="Travel Resources" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent"></div>
    </div>
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-4xl font-bold text-white mb-6">
            Travel <span class="text-gradient bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">Resources</span>
        </h1>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="resource-card bg-white rounded-2xl p-8 text-center cursor-pointer" onclick="showResourceCategory('visas')">
            ...
            <div class="resource-card bg-white rounded-2xl p-8 text-center cursor-pointer" onclick="showResourceCategory('safety')">
            ...
            <div class="resource-card bg-white rounded-2xl p-8 text-center cursor-pointer" onclick="showResourceCategory('packing')">
            ...
            <div class="resource-card bg-white rounded-2xl p-8 text-center cursor-pointer" onclick="showResourceCategory('culture')">
