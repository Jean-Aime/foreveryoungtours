...
$page_description = "Submit your tour inquiry with Forever Young Tours";
...
<section class="py-20 bg-slate-50 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8">
            ...
            <p class="text-slate-600">Tell us about your dream African adventure and we'll create a custom itinerary</p>
        </div>
