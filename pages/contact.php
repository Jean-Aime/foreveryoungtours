        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="space-y-6 mb-8">
                    ...
                    <div class="bg-green-50 rounded-xl p-6 flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">+254 720 000 000</p>
                        </div>
                    </div>
                    
                    <div class="bg-purple-50 rounded-xl p-6 flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">info@foreveryoungtours.com</p>
                            <p class="text-gray-600">bookings@foreveryoungtours.com</p>
                        </div>
                    </div>
                    
                    <div class="bg-orange-50 rounded-xl p-6 flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Sat: 9:00 AM - 4:00 PM</p>
