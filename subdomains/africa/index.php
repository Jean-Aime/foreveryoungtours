...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden" id="hero">
    ...
    <div class="absolute inset-0 z-0" data-parallax>
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-slate-900/90 via-slate-800/80 to-yellow-900/70"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <!-- Region Badge -->
        <div class="inline-flex items-center px-6 py-3 bg-yellow-600/20 backdrop-blur-md border border-yellow-400/30 rounded-full mb-8 animate-fade-in-down shadow-xl shadow-yellow-600/10">
            <svg class="w-5 h-5 text-yellow-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path>
            </svg>
            <span class="text-yellow-300 font-bold text-sm uppercase tracking-wider">Explore the Continent</span>
        </div>
        ...
        <h1 class="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-white mb-6 leading-tight animate-fade-in">
            ...
            <span class="block bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-400 bg-clip-text text-transparent">
        ...
        <div class="flex flex-wrap gap-4 justify-center mb-8 animate-fade-in-up">
            <a href="#countries" class="group relative bg-gradient-to-r from-yellow-600 to-yellow-500 text-white px-10 py-4 rounded-full font-bold overflow-hidden shadow-2xl shadow-yellow-600/50 hover:shadow-yellow-600/70 transition-all duration-300 hover:scale-105">
                ...
                <div class="absolute inset-0 bg-gradient-to-r from-yellow-700 to-yellow-600 opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </a>
        ...
        <div class="flex flex-wrap justify-center gap-6 text-sm text-white/80 animate-fade-in-up">
            <a href="tel:+17374439646" class="flex items-center gap-2 hover:text-yellow-400 transition-colors">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                </svg>
                +1 737 443 9646
            </a>
            <a href="mailto:info@iforeveryoungtours.com" class="flex items-center gap-2 hover:text-yellow-400 transition-colors">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
...
<section id="countries" class="py-20 bg-gradient-to-b from-white to-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <span class="inline-block px-4 py-2 bg-yellow-100 text-yellow-800 rounded-full text-sm font-semibold mb-4 uppercase tracking-wide">Destinations</span>
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer transform hover:-translate-y-2" onclick="window.open('<?php echo $country_url; ?>', '_blank')">
                <div class="relative h-64 sm:h-72 overflow-hidden">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-6">
                        <h3 class="text-xl sm:text-2xl font-bold text-white mb-2 group-hover:text-yellow-400 transition-colors"><?php echo htmlspecialchars($country['name']); ?></h3>
...
<!-- CTA Section -->
<section class="py-20 bg-gradient-to-r from-yellow-600 via-yellow-500 to-yellow-600">
...
::-webkit-scrollbar-thumb:hover {
    background: linear-gradient(180deg, #B8860B, #9A7810);
}
