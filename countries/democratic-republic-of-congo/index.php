...
$page_title = "Discover Democratic Republic of Congo | Luxury Group Travel, Primate Safaris, Culture | Forever Young Tours";
$meta_description = "Premium Democratic Republic of Congo travel. Gorillas, chimps, volcanoes, canopy walks, culture. Curated 6–10 day programs, premium lodges, seamless logistics. Request dates via WhatsApp or email.";
require_once __DIR__ . '/../../config/database.php';

// Get Democratic Republic of Congo data
$stmt = $pdo->prepare("SELECT c.*, r.name as continent_name FROM countries c LEFT JOIN regions r ON c.region_id = r.id WHERE c.slug = 'visit-cd' AND c.status = 'active'");
$stmt->execute();
$country = $stmt->fetch();
...
<head>
    ...
    <link rel="canonical" href="https://visit-cd.iforeveryoungtours.com/">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://visit-cd.iforeveryoungtours.com/">
    <meta property="og:title" content="<?= $page_title ?>">
    <meta property="og:description" content="<?= $meta_description ?>">
    <meta property="og:image" content="https://visit-cd.iforeveryoungtours.com/assets/images/democratic republic of congo-og.jpg">
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://visit-cd.iforeveryoungtours.com/">
    <meta property="twitter:title" content="<?= $page_title ?>">
    <meta property="twitter:description" content="<?= $meta_description ?>">
    <meta property="twitter:image" content="https://visit-cd.iforeveryoungtours.com/assets/images/democratic republic of congo-og.jpg">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Premium Democratic Republic of Congo travel with gorilla, chimp, and golden monkey encounters. Curated itineraries, premium lodges, and on-ground FYT operations.",
      "url": "https://visit-cd.iforeveryoungtours.com/",
      ...
      "provider": {
        ...
        "address": {
          "@type": "PostalAddress",
          "streetAddress": "Democratic Republic of Congo Operations Center",
          "addressLocality": "Democratic Republic of Congo",
          "addressCountry": "RW"
        }
      },
      "hasPart": [
        {
          "@type": "TouristTrip",
          "name": "6 Days Democratic Republic of Congo Premium Primate Safari",
          "itinerary": "Democratic Republic of Congo • Nyungwe • Volcanoes • Democratic Republic of Congo",
          "offers": {
            "@type": "Offer",
            "price": "4600",
            "priceCurrency": "USD",
...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden" id="hero">
    ...
    <div class="absolute inset-0 z-0" data-parallax>
        <img src="<?= getImageUrl('assets/images/democratic republic of congo-gorilla-hero.png') ?>" alt="Democratic Republic of Congo Gorillas" class="w-full h-full object-cover scale-110">
        ...
        <div class="max-w-6xl mx-auto text-center">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-12 max-w-5xl mx-auto animate-fade-in-up px-4 sm:px-0">
                <div class="bg-gradient-to-br from-amber-500/20 to-orange-500/20 backdrop-blur-md p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-amber-400/30 hover:scale-105 transition-transform duration-300 shadow-xl shadow-amber-500/10">
                    ...
                    <div class="text-xl sm:text-2xl font-black text-white mb-1">Democratic Republic of Congo</div>
            ...
            <div class="flex flex-wrap gap-4 justify-center mb-8 animate-fade-in-up">
                ...
                <a href="https://wa.me/17374439646?text=Democratic Republic of Congo%20Inquiry" class="group relative bg-white text-gray-900 px-10 py-4 rounded-full font-bold overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105">
                    <span class="relative z-10 flex items-center gap-2">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="text-white/80 text-sm animate-fade-in-up flex flex-wrap justify-center gap-4">
                <span class="flex items-center gap-2">
                    ...
                    Democratic Republic of Congo Operations Center
                </span>
                <span class="flex items-center gap-2">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
...
<section class="py-20 bg-gradient-to-b from-white to-gray-50">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Premium Democratic Republic of Congo Experience</h2>
        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div class="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
                ...
                <p class="text-gray-600 leading-relaxed">FYT on-ground team in Democratic Republic of Congo. Zero friction transfers and 24/7 support.</p>
            </div>
            <div class="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-600 text-lg">Curated Democratic Republic of Congo experiences designed for unforgettable moments</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div class="relative overflow-hidden">
                    <img src="<?= getImageUrl($tour['image_url'] ?: $tour['cover_image'], 'assets/images/africa.png') ?>" alt="<?= htmlspecialchars($tour['name']) ?>" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-500">
...
<section class="py-20 bg-gray-50">
    <div class="w-full">
        <h2 class="text-4xl font-bold text-center mb-12">Democratic Republic of Congo Experiences</h2>
        ...
        <div class="relative overflow-hidden">
            <div class="flex gap-0 animate-scroll-left">
                ...
                $experiences_row2 = [
                    ...
                    ['category' => 'Culture', 'title' => 'Democratic Republic of Congo Craft & Culinary', 'image' => 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800'],
...
<section class="relative py-20 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 text-center text-white">
        ...
        <div class="flex flex-wrap gap-4 justify-center">
            ...
            <a href="https://wa.me/17374439646?text=Democratic Republic of Congo%20Pricing%20Request" class="group border-2 border-white text-white px-10 py-4 rounded-full font-bold hover:bg-white/10 backdrop-blur-sm transition-all duration-300 hover:scale-105">
                <span class="flex items-center gap-2">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                    </svg>
...
<div id="requestModal" class="fixed inset-0 bg-black/50 z-50 hidden flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div class="sticky top-0 bg-white border-b px-8 py-6 flex justify-between items-center">
            <h2 class="text-3xl font-bold">Request Democratic Republic of Congo Dates</h2>
        ...
        <div class="p-8">
            <form action="../../pages/inquiry-form.php" method="POST">
                <input type="hidden" name="tour_name" id="modal_tour_name" value="Democratic Republic of Congo Dates Request">
            ...
            <div class="text-center mt-6">
                ...
                <a href="https://wa.me/17374439646?text=Democratic Republic of Congo%20Dates%20Request" class="inline-flex items-center gap-2 bg-green-500 text-white px-6 py-3 rounded-lg font-bold hover:bg-green-600">
...
<script>
function openRequestModal(tourName = 'Democratic Republic of Congo Dates Request') {
...
<section class="py-20 bg-gradient-to-b from-gray-50 to-white">
    <div class="max-w-4xl mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-600 text-lg">Everything you need to know about Democratic Republic of Congo travel</p>
        </div>
        <div class="space-y-4">
            <?php 
            $faqs = [
                ...
                ['q' => 'Can I combine Akagera Big Five with gorillas?', 'a' => 'Absolutely! We recommend 8-10 day circuits that combine Volcanoes National Park (gorillas), Nyungwe Forest (chimps & canopy walk), and Akagera National Park (Big Five safari). This gives you the complete Democratic Republic of Congo wildlife experience.'],
                ...
                ['q' => 'Do you support private departures?', 'a' => 'Yes. All our Democratic Republic of Congo programs can be customized for private departures with flexible dates. We tailor itineraries to your preferences, pace, and interests. Contact us for a personalized quote.']
            ];
...
<div class="fixed bottom-6 right-6 z-50">
    ...
    <div id="whatsappDropup" class="hidden mb-4 bg-white rounded-2xl shadow-2xl w-80 animate-slide-up">
        ...
        <div class="p-6">
            <p class="text-gray-700 mb-4 text-sm">Get instant answers about Democratic Republic of Congo tours, pricing, and availability.</p>
            ...
            <a href="https://wa.me/17374439646?text=Hi!%20I%20need%20help%20with%20Democratic Republic of Congo%20travel" class="block w-full bg-green-500 hover:bg-green-600 text-white text-center py-3 rounded-xl font-bold transition text-sm">
