...
<section class="relative w-full min-h-screen flex items-center justify-center">
    <div class="absolute inset-0 z-0 w-full h-full">
        <img src="https://images.pexels.com/photos/3708169/pexels-photo-3708169.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="<?= htmlspecialchars($country['name']) ?>" class="w-full h-full object-cover" onerror="this.src='https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?auto=format&fit=crop&w=2070&q=80';">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        <p class="text-sm sm:text-base md:text-lg text-gray-50 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed drop-shadow-md px-2">
            <?= htmlspecialchars($country['tourism_description'] ?: $country['description'] ?: 'Experience Uganda\'s spectacular wildlife, lush rainforests, and the mighty Nile River. Discover the Pearl of Africa with its diverse landscapes and warm people.') ?>
        </p>
