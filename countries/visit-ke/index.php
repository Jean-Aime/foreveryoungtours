...
<section class="relative w-full min-h-screen flex items-center justify-center">
    <div class="absolute inset-0 z-0 w-full h-full">
        <img src="https://images.pexels.com/photos/3408357/pexels-photo-3408357.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="<?= htmlspecialchars($country['name']) ?>" class="w-full h-full object-cover" onerror="this.src='https://via.placeholder.com/1920x1080/333333/ffffff?text=Kenya';">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        <p class="text-sm sm:text-base md:text-lg text-gray-50 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed drop-shadow-md px-2">
            <?= htmlspecialchars($country['tourism_description'] ?: $country['description'] ?: 'Experience Kenya\'s incredible wildlife, stunning landscapes, and vibrant culture. From Mount Kenya to the Great Rift Valley, discover Africa\'s best adventures.') ?>
        </p>
