            ...
            <div class="grid lg:grid-cols-3 gap-12">
                ...
                <div class="grid grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="<?php echo url('resources'); ?>" class="text-gray-600 hover:text-yellow-600 transition-colors">Travel Resources</a></li>
                            <li><a href="<?php echo url('resources#visa'); ?>" class="text-gray-600 hover:text-yellow-600 transition-colors">VISA Information</a></li>
                            <li><a href="<?php echo url('resources#safety'); ?>" class="text-gray-600 hover:text-yellow-600 transition-colors">Travel Safety</a></li>
                            <li><a href="<?php echo url('faq'); ?>" class="text-gray-600 hover:text-yellow-600 transition-colors">FAQ</a></li>
                            <li><a href="<?php echo url('terms'); ?>" class="text-gray-600 hover:text-yellow-600 transition-colors">Terms & Conditions</a></li>
                            <li><a href="<?php echo url('privacy'); ?>" class="text-gray-600 hover:text-yellow-600 transition-colors">Privacy Policy</a></li>
                        </ul>
                    </div>
                </div>
