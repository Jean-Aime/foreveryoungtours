...
$page_title = "Discover Cameroon | Luxury Group Travel & Safari Adventures | Forever Young Tours";
$meta_description = "Premium Cameroon travel experiences. Luxury tours, cultural immersion, and adventure activities.";
...
<head>
    ...
    <meta property="og:image" content="http://foreveryoungtours.local/assets/images/cameroon-og.jpg">
    ...
    <meta property="twitter:image" content="http://foreveryoungtours.local/assets/images/cameroon-og.jpg">
...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden" id="hero">
    ...
    <div class="absolute inset-0 z-0" data-parallax>
        <img src="<?= getImageUrl('countries/rwanda/assets/images/hero-rwanda.jpg') ?>" alt="Cameroon Gorillas" class="w-full h-full object-cover scale-110" onerror="this.src='<?= getImageUrl('countries/rwanda/assets/images/cameroon-hero.png') ?>'; this.onerror=function(){this.src='<?= getImageUrl('assets/images/africa.png') ?>';}">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="max-w-6xl mx-auto text-center">
            ...
            <p class="text-lg sm:text-xl md:text-2xl text-gray-200 mb-12 leading-relaxed max-w-4xl mx-auto animate-fade-in-up font-light">
                Adventure. Culture. Luxury. Premium by design.
            </p>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-12 max-w-5xl mx-auto animate-fade-in-up px-4 sm:px-0">
                ...
                <div class="bg-gradient-to-br from-emerald-500/20 to-green-500/20 backdrop-blur-md p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-emerald-400/30 hover:scale-105 transition-transform duration-300 shadow-xl shadow-emerald-500/10">
                    ...
                    <div class="text-xl sm:text-2xl font-black text-white mb-1">N/A</div>
                ...
                <div class="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-md p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-purple-400/30 hover:scale-105 transition-transform duration-300 shadow-xl shadow-purple-500/10">
                    ...
                    <div class="text-xl sm:text-2xl font-black text-white mb-1">Central African CFA Franc (XAF)</div>
