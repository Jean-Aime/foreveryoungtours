...
$stmt = $pdo->prepare("SELECT c.*, r.name as country_name, r.slug as country_slug FROM countries c LEFT JOIN regions r ON c.region_id = r.id WHERE c.slug = ? AND c.status = 'active'");
