        ...
        <div id="toursCarousel" class="relative">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300">
                    ...
                    $image_src = $tour_image ? 'http://localhost/ForeverYoungTours/' . $tour_image : 'http://localhost/ForeverYoungTours/assets/images/default-tour.jpg';
                    ?>
                    <img src="<?= $image_src ?>" alt="<?php echo htmlspecialchars($tour['name']); ?>" class="w-full h-56 object-cover" onerror="this.src='http://localhost/ForeverYoungTours/assets/images/default-tour.jpg'">
                    <div class="p-6">
                    ...
                    <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                        <div class="flex">
                            <div class="w-24 h-20 flex-shrink-0">
                                ...
                                ?>
                                <?php 
                                $tour_img = $tour['cover_image'] ?: $tour['image_url'];
                                $img_src = $tour_img ? 'http://localhost/ForeverYoungTours/' . $tour_img : 'http://localhost/ForeverYoungTours/assets/images/default-tour.jpg';
                                ?>
                                <img src="<?= $img_src ?>" alt="<?php echo htmlspecialchars($tour['name']); ?>" class="w-full h-full object-cover" onerror="this.src='http://localhost/ForeverYoungTours/assets/images/default-tour.jpg';">
                            </div>
