        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid lg:grid-cols-3 gap-12">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-4">
                        <img src="<?= BASE_URL ?>/assets/images/logo.png" alt="Forever Young Tours Logo" class="w-12 h-12">
                        <div>
                ...
                <div class="grid grid-cols-2 gap-8">
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="<?= BASE_URL ?>/pages/packages.php?category=adventure" class="text-gray-600 hover:text-yellow-600 transition-colors">Adventure Tours</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/packages.php?category=luxury" class="text-gray-600 hover:text-yellow-600 transition-colors">Luxury Travel</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/packages.php?category=cultural" class="text-gray-600 hover:text-yellow-600 transition-colors">Cultural Tours</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/packages.php?category=wildlife" class="text-gray-600 hover:text-yellow-600 transition-colors">Wildlife Safari</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/packages.php?category=agro" class="text-gray-600 hover:text-yellow-600 transition-colors">Agro-Tourism</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/store.php" class="text-gray-600 hover:text-yellow-600 transition-colors">Travel Store</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="font-semibold text-gray-900 mb-4">Resources</h4>
                        <ul class="space-y-2 text-sm">
                            <li><a href="<?= BASE_URL ?>/pages/resources.php" class="text-gray-600 hover:text-yellow-600 transition-colors">Travel Resources</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/resources.php#visa" class="text-gray-600 hover:text-yellow-600 transition-colors">VISA Information</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/resources.php#safety" class="text-gray-600 hover:text-yellow-600 transition-colors">Travel Safety</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/faq.php" class="text-gray-600 hover:text-yellow-600 transition-colors">FAQ</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/terms.php" class="text-gray-600 hover:text-yellow-600 transition-colors">Terms & Conditions</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/privacy.php" class="text-gray-600 hover:text-yellow-600 transition-colors">Privacy Policy</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="border-t border-gray-200 mt-8 pt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="#" class="text-yellow-600 hover:underline">Terms & Conditions</a>
                    <span class="mx-2">|</span>
                    <a href="#" class="text-yellow-600 hover:underline">Privacy Policy</a>
                    <span class="mx-2">|</span>
                    <a href="#" class="text-yellow-600 hover:underline">Sitemap</a>
                </p>
            </div>
        </div>
    </footer>
