<?php
// Include main config for BASE_URL
...
<head>
    ...
    <!-- Modern Styles -->
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/css/modern-styles.css">
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/css/responsive-utilities.css">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-3">
                    <img src="<?= BASE_URL ?>/assets/images/logo.png" alt="iForYoungTours Logo" class="w-10 h-10">

                </div>

                <!-- Desktop Navigation -->
                <div class="hidden lg:flex items-center space-x-1">
                    <a href="<?= BASE_URL ?>/index.php" class="px-4 py-2 text-slate-700 hover:text-slate-900 hover:bg-slate-100 rounded-lg font-medium transition-all">Home</a>

                    <!-- Solution Dropdown -->
                    <div class="relative dropdown-container">
                        <a href="<?= BASE_URL ?>/pages/solutions.php" class="px-4 py-2 text-slate-700 hover:text-slate-900 hover:bg-slate-100 rounded-lg font-medium transition-all flex items-center space-x-1" onmouseover="showDropdown('solutionDropdown')" onmouseout="hideDropdown('solutionDropdown')">
                            <span>Solution</span>
                        ...
                        <div id="solutionDropdown" class="nextcloud-dropdown-mega hidden" onmouseover="showDropdown('solutionDropdown')" onmouseout="hideDropdown('solutionDropdown')">
                            <div class="dropdown-grid">
                                <div class="dropdown-column">
                                    <a href="<?= BASE_URL ?>/pages/destinations.php" class="dropdown-item-large">
                                    ...
                                    <a href="<?= BASE_URL ?>/pages/booking-engine.php" class="dropdown-item-large">
                                    ...
                                    <a href="<?= BASE_URL ?>/pages/packing-guide.php" class="dropdown-item-large">
                                    ...
                                    <a href="<?= BASE_URL ?>/pages/travel-tips.php" class="dropdown-item-large">
                                ...
                                <div class="dropdown-column">
                                    <a href="<?= BASE_URL ?>/pages/emergency.php" class="dropdown-item-large">
                                    ...
                                    <a href="<?= BASE_URL ?>/pages/vip-support.php" class="dropdown-item-large">
                                    ...
                                    <a href="<?= BASE_URL ?>/pages/personalized-planning.php" class="dropdown-item-large">
                    ...
                    <!-- Community Dropdown -->
                    <div class="relative dropdown-container">
                        <a href="<?= BASE_URL ?>/pages/community.php" class="px-4 py-2 text-slate-700 hover:text-slate-900 hover:bg-slate-100 rounded-lg font-medium transition-all flex items-center space-x-1" onmouseover="showDropdown('communityDropdown')" onmouseout="hideDropdown('communityDropdown')">
                            <span>Community</span>
                            <svg class="w-4 h-4 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        ...
                        <div id="communityDropdown" class="nextcloud-dropdown-mega hidden" onmouseover="showDropdown('communityDropdown')" onmouseout="hideDropdown('communityDropdown')">
                            <div class="dropdown-grid">
                                <div class="dropdown-column">
                                    <a href="<?= BASE_URL ?>/pages/community.php" class="dropdown-item-large">
                                        <div class="dropdown-icon-large bg-yellow-500">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?= BASE_URL ?>/pages/blog.php" class="dropdown-item-large">
                                        <div class="dropdown-icon-large bg-green-500">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
                                            </svg>
                                        ...
                                        <div>
                                            <div class="dropdown-title-large">Experience</div>
                                            <div class="dropdown-desc-large">Travel stories and insights</div>
                                        </div>
                                    </a>
                                </div>
                                <div class="dropdown-column">
                                    <a href="<?= BASE_URL ?>/pages/advisor-network.php" class="dropdown-item-large">
                                        <div class="dropdown-icon-large bg-blue-500">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            ...
                                            <div class="dropdown-desc-large">Connect with travel advisors</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <!-- Resources Dropdown -->
                    <div class="relative dropdown-container">
                        <a href="<?= BASE_URL ?>/pages/resources.php" class="px-4 py-2 text-slate-700 hover:text-slate-900 hover:bg-slate-100 rounded-lg font-medium transition-all flex items-center space-x-1" onmouseover="showDropdown('resourcesDropdown')" onmouseout="hideDropdown('resourcesDropdown')">
                            <span>Resources</span>
                            <svg class="w-4 h-4 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        ...
                        <div id="resourcesDropdown" class="nextcloud-dropdown-mega hidden" onmouseover="showDropdown('resourcesDropdown')" onmouseout="hideDropdown('resourcesDropdown')">
                            <div class="dropdown-grid">
                                <div class="dropdown-column">
                                    <a href="/pages/resources.php" class="dropdown-item-large">
                                        <div class="dropdown-icon-large bg-blue-500">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                                            </svg>
                    ...
                    <a href="<?= BASE_URL ?>/pages/contact.php" class="px-4 py-2 text-slate-700 hover:text-slate-900 hover:bg-slate-100 rounded-lg font-medium transition-all">Contact Us</a>
                </div>
                ...
                <div class="flex items-center space-x-3">
                    <?php if (isset($_SESSION['user_id']) && isset($_SESSION['user_role'])): ?>
                        ...
                        <a href="<?php 
                            echo match($_SESSION['user_role']) {
                                'super_admin', 'admin' => BASE_URL . '/admin/index.php',
                                'mca' => BASE_URL . '/mca/index.php',
                                'advisor' => BASE_URL . '/advisor/index.php',
                                'client' => BASE_URL . '/client/index.php',
                    ...
                    <?php else: ?>
                        <!-- Login Button -->
                        <a href="<?= BASE_URL ?>/auth/login.php" target="_blank" class="px-4 py-2 text-slate-700 hover:text-slate-900 hover:bg-slate-100 rounded-lg font-medium transition-all flex items-center space-x-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Book Now Button -->
                    <a href="<?= BASE_URL ?>/pages/packages.php" class="btn-primary px-6 py-2 rounded-lg font-semibold">Book Now
                    </a>
            ...
            <div id="mobileMenu" class="lg:hidden bg-white border-t border-slate-200 hidden">
                <div class="px-4 py-6 space-y-2">
                    <a href="<?= BASE_URL ?>/index.php" class="block px-4 py-2 text-slate-700 hover:bg-slate-100 rounded-lg font-medium transition-colors">Home</a>
                    <a href="<?= BASE_URL ?>/pages/solutions.php" class="block px-4 py-2 text-slate-700 hover:bg-slate-100 rounded-lg font-medium transition-colors">Solution</a>
                    <a href="<?= BASE_URL ?>/pages/community.php" class="block px-4 py-2 text-slate-700 hover:bg-slate-100 rounded-lg font-medium transition-colors">Community</a>
                    <a href="<?= BASE_URL ?>/pages/resources.php" class="block px-4 py-2 text-slate-700 hover:bg-slate-100 rounded-lg font-medium transition-colors">Resources</a>
                    <a href="<?= BASE_URL ?>/pages/contact.php" class="block px-4 py-2 text-slate-700 hover:bg-slate-100 rounded-lg font-medium transition-colors">Contact Us</a>
                    <div class="pt-4 mt-4 border-t border-slate-200">
                        <a href="<?= BASE_URL ?>/auth/login.php" target="_blank" class="block px-4 py-2 text-slate-700 hover:bg-slate-100 rounded-lg font-medium transition-colors mb-2">Login</a>
                        <a href="<?= BASE_URL ?>/pages/packages.php" class="block btn-primary px-6 py-3 rounded-lg font-semibold text-center">
                            Book Now
                        </a>
                    </div>
                </div>
