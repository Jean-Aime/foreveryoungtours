    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl p-8 shadow-sm border sticky top-24"><div class="space-y-4 mb-6">
        ...
        <div class="bg-white rounded-xl p-8 shadow-sm border">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-sm border hover:shadow-md transition-shadow">
                    <?php 
                    $related_path = $related['cover_image'] ?: $related['image_url'];
                    if ($related_path && !empty(trim($related_path))) {
                        $related_image = 'http://localhost/foreveryoungtours/' . ltrim($related_path, '/');
                    } else {
                        $related_image = 'http://localhost/foreveryoungtours/assets/images/default-tour.jpg';
                    }
                    ?>
