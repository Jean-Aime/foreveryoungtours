        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden xl:flex items-center space-x-1">
                        ...
                        <div id="solutionDropdown" class="nextcloud-dropdown-mega hidden" onmouseover="showDropdown('solutionDropdown')" onmouseout="hideDropdown('solutionDropdown')">
                            <div class="dropdown-grid">
                                <div class="dropdown-column">
                                    <a href="<?php echo $base_path; ?>pages/destinations" class="dropdown-item-large">
                                    ...
                                    <a href="<?php echo $base_path; ?>pages/booking-engine" class="dropdown-item-large">
                    ...
                    <div class="relative dropdown-container">
                        ...
                        <div id="communityDropdown" class="nextcloud-dropdown-mega hidden" onmouseover="showDropdown('communityDropdown')" onmouseout="hideDropdown('communityDropdown')">
                            <div class="dropdown-grid">
                                <div class="dropdown-column">
                                    <a href="<?php echo $base_path; ?>pages/travel-club-membership" class="dropdown-item-large">
                                    ...
                                    <a href="<?php echo $base_path; ?>pages/mca-advisor-network" class="dropdown-item-large">
                                        <div class="dropdown-icon-large bg-green-500">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
                                            </svg>
                    ...
                    <div class="relative dropdown-container">
                        ...
                        <div id="resourcesDropdown" class="nextcloud-dropdown-mega hidden" onmouseover="showDropdown('resourcesDropdown')" onmouseout="hideDropdown('resourcesDropdown')">
                            <div class="dropdown-grid">
                                <div class="dropdown-column">
                                    <a href="<?php echo $base_path; ?>pages/packing-guides-resources" class="dropdown-item-large">
                                        <div class="dropdown-icon-large bg-blue-500">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?php echo $base_path; ?>pages/travel-tips-resources" class="dropdown-item-large">
                                        <div class="dropdown-icon-large bg-green-500">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?php echo $base_path; ?>pages/destination-guides" class="dropdown-item-large">
                                        <div class="dropdown-icon-large bg-purple-500">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                                            </svg>
                                ...
                                <div class="dropdown-column">
                                    <a href="<?php echo $base_path; ?>pages/senior-discounts" class="dropdown-item-large">
                                    ...
                                    <a href="<?php echo $base_path; ?>pages/cultural-etiquette" class="dropdown-item-large">
                                        <div class="dropdown-icon-large bg-red-500">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?php echo $base_path; ?>pages/visa-documents" class="dropdown-item-large">
                                        <div class="dropdown-icon-large bg-indigo-500">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <?php else: ?>
                        <!-- Login Button -->
                        <a href="<?php echo $base_path; ?>auth/login" target="_blank" class="px-4 py-2 text-slate-700 hover:text-slate-900 hover:bg-slate-100 rounded-lg font-medium transition-all flex items-center space-x-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Book Now Button -->
                    <a href="<?php echo $base_path; ?>pages/packages" class="btn-primary px-6 py-2 rounded-lg font-semibold">Book Now
                    </a>
            ...
            <div id="mobileMenu" class="xl:hidden bg-white border-t border-slate-200 shadow-lg" style="display: none; position: absolute; top: 100%; left: 0; right: 0; z-index: 9999; max-height: 80vh; overflow-y: auto;">
                <div class="px-4 py-6 space-y-2">
                    ...
                    <!-- Solution -->
                    <div class="space-y-1">
                        <a href="<?php echo $base_path; ?>pages/solutions" class="block px-4 py-2 text-slate-900 font-semibold bg-slate-50 hover:bg-slate-100 rounded-lg transition-colors">Solution</a>
                        <div class="pl-4 space-y-1">
                            ...
                            <a href="<?php echo $base_path; ?>pages/store" class="block px-4 py-2 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-lg text-sm transition-colors">Store</a>
                        </div>
                    </div>
                    
                    <!-- Community -->
                    <div class="space-y-1">
                        <a href="<?php echo $base_path; ?>pages/community" class="block px-4 py-2 text-slate-900 font-semibold bg-slate-50 hover:bg-slate-100 rounded-lg transition-colors">Community</a>
                        <div class="pl-4 space-y-1">
                            <a href="<?php echo $base_path; ?>pages/travel-club-membership" class="block px-4 py-2 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-lg text-sm transition-colors">Travel Club Membership</a>
                            <a href="<?php echo $base_path; ?>pages/mca-advisor-network" class="block px-4 py-2 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-lg text-sm transition-colors">MCA & Advisor Network</a>
                            <a href="<?php echo $base_path; ?>pages/partners" class="block px-4 py-2 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-lg text-sm transition-colors">Partners</a>
                        </div>
                    </div>
                    
                    <!-- Resources -->
                    <div class="space-y-1">
                        <a href="<?php echo $base_path; ?>pages/resources" class="block px-4 py-2 text-slate-900 font-semibold bg-slate-50 hover:bg-slate-100 rounded-lg transition-colors">Resources</a>
                        <div class="pl-4 space-y-1">
                            <a href="<?php echo $base_path; ?>pages/packing-guides-resources" class="block px-4 py-2 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-lg text-sm transition-colors">Packing Guides</a>
                            <a href="<?php echo $base_path; ?>pages/travel-tips-resources" class="block px-4 py-2 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-lg text-sm transition-colors">Travel Tips</a>
                            <a href="<?php echo $base_path; ?>pages/destination-guides" class="block px-4 py-2 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-lg text-sm transition-colors">Destination Guides</a>
                            <a href="<?php echo $base_path; ?>pages/senior-discounts" class="block px-4 py-2 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-lg text-sm transition-colors">Senior Discounts</a>
                            <a href="<?php echo $base_path; ?>pages/cultural-etiquette" class="block px-4 py-2 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-lg text-sm transition-colors">Cultural & Etiquette</a>
