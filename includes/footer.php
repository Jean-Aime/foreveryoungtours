            ...
            <div class="grid lg:grid-cols-3 gap-12">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-4">
                        <img src="<?php echo isset($base_path) ? $base_path : '/foreveryoungtours/'; ?>assets/images/logo.png" alt="Forever Young Tours Logo" class="w-12 h-12" onerror="this.src='<?php echo isset($base_path) ? $base_path : '/foreveryoungtours/'; ?>assets/images/logo.svg'; this.onerror=null;">
                        <div>
